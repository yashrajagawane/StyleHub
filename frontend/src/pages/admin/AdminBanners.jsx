...
export default function AdminBanners() {
  return (
    <CrudManager
      ...
      defaultItem={{ title: "", subtitle: "", image: "", cta_text: "", cta_link: "", position: "hero", display_order: 0, active: true }}
      fields={[
        ...
        { key: "position", label: "Position", type: "select", options: [
          { value: "hero", label: "Hero" }, { value: "secondary", label: "Secondary" }, { value: "promo", label: "Promo" },
        ], colSpan: 3 },
